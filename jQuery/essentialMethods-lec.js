...
// // var html = "";
// //
// // html = "<h4 class=\"best-seller-header\">Our Top Sellers</h4><ol><li>Fedora Hats</li><li>Baseball Hats</li><li>Cowboy Hats</li></ol>"
//
...
//
// $(".modal-body").css("color", "rebeccapurple");
//
...
//
// $("h1").css(warningRed).css("color", "white")
//
...
// // })
//
// //Bonus activity [if you finish exers]:
//
...
//     e.preventDefault();
//     $("nav").toggleClass("bg-dark bg-info");
//     $("nav").toggleClass("navbar-dark navbar-light");
//     // $("nav").toggleClass("bg-info");
...
//
// $("ol").each().children().last(function(){
//     console.log($(this));
// })
